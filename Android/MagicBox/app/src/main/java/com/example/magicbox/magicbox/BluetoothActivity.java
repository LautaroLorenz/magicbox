...
import com.example.magicbox.magicbox.activities.DeviceListActivity;
import com.example.magicbox.magicbox.activities.MainActivity;
...
public class BluetoothActivity extends Activity
{
	...
	private Button btnComunication;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btnComunication = (Button) findViewById(R.id.btnComunication);
	...
	protected  void enableComponent()
	{
		...
		else
		{
			...
			btnComunication.setOnClickListener(btnComunicationListener);
	...
	private View.OnClickListener btnComunicationListener = new View.OnClickListener() {
		@Override
		public void onClick(View v) {
			Intent intent = new Intent(BluetoothActivity.this, activity_comunicacion.class);
